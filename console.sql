...
SELECT COUNT(brand) AS brand_name FROM cars WHERE brand = 'Chevrolet';
...
SELECT MAX(price) AS most_expensive, MIN(price) AS mini_price FROM cars;

SELECT * FROM cars WHERE brand = 'Toyota';

SELECT * FROM cars MAX(price) LIMIT 10;

SELECT * FROM cars OFFSET 5 LIMIT 10;
